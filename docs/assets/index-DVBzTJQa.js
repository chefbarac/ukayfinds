(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function s(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(t){if(t.ep)return;t.ep=!0;const a=s(t);fetch(t.href,a)}})();const Y=document.getElementById("fbMessage"),m=document.getElementById("search"),L=document.getElementById("clear-search"),U=document.getElementById("btnToggleFilters"),$=document.getElementById("controls"),S=document.getElementById("collection"),k=document.getElementById("size"),F=document.getElementById("category"),w=document.getElementById("status"),h=document.getElementById("products"),B=document.getElementById("scrollTopBtn"),z=document.getElementById("btnToggleFavorites"),j=document.getElementById("btnClearFilters"),T=document.getElementById("resultInfo"),G=document.getElementById("resultCounter"),H="/ukayfinds/assets/products-CpXvKsRg.json",W="/ukayfinds/assets/products_sold-CRz2l8sR.json";function x(e,n=2500){let s=document.createElement("div");s.textContent=e,s.style.cssText=`
        position: fixed;
        top: 24px;
        left: 50%;
                          ...
                          <div class="carousel" id="carousel-${o.id}">
                            ...
                            <div class="thumbs">
                              ${o.images.map((y,D)=>`
                                        ...
                                        data-product-id="${o.id}"
                                        data-index="${D}"  >
                                        <img src="${C(y)}=w100" class="thumbnail"  loading="lazy">
                                        </div>
                                    `).join("")}
                            </div>
                          </div>
